...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    if (mLabelsStyle != 0 && expandsHorizontally()) {
      throw new IllegalStateException("Yatay genişleme yönündeki eylem etiketleri desteklenmez.");
    }
...
//ÜSTTEKİ yerine ALTTTAKİ eklendi
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    case EXPAND_DOWN:
      ...
      // mAddButton öğesinin, düğmelerin olması gereken hatta ortalandığından emin olun
  ...
  private class LayoutParams extends ViewGroup.LayoutParams {
    ...
    public void setAnimationsTarget(View view) {
      ...
      // Şimdi animasyonların hedefleri var, oynatılmaya ayarlandı
