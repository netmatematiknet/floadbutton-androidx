...
public class FloatingActionButton extends AppCompatImageButton {
  ...
  public void setSize(@FAB_SIZE int size) {
    if (size != SIZE_MINI && size != SIZE_NORMAL) {
      throw new IllegalArgumentException("Sadece @FAB_SIZE sabitlerini kullanın!");
    }
  ...
  /**
   * @return normal durum için geçerli Renk..
   */
  ...
  /**
   * @return basılı durum için geçerli renk.
   */
  ...
  /**
  * @return devre dışı durum için geçerli renk.
  */
